...
class MCIPStoreCallback extends MCCallbackBase {
	...
	public function getIPs($table, $auto_increment_offset, $type, $category) {
		...
		$query .= ($category == MCProtectIpstoreDB_V669::CATEGORY_FW) ? "`is_fw` = true;" : "`is_lp` = true;";
	...
	public function getIPStoreInfo($table, $auto_increment_offset) {
		...
		$info['fw_blacklisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			MCProtectIpstoreDB_V669::blacklistedTypes(), MCProtectIpstoreDB_V669::CATEGORY_FW);
		$info['lp_blacklisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			MCProtectIpstoreDB_V669::blacklistedTypes(), MCProtectIpstoreDB_V669::CATEGORY_LP);
		$info['fw_whitelisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			MCProtectIpstoreDB_V669::whitelistedTypes(), MCProtectIpstoreDB_V669::CATEGORY_FW);
		$info['lp_whitelisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			MCProtectIpstoreDB_V669::whitelistedTypes(), MCProtectIpstoreDB_V669::CATEGORY_LP);
