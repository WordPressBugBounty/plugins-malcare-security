...
if (!class_exists('MCProtectFWRuleEngine_V665')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V665 {
	use MCProtectFWRuleStringFunc_V665;
	use MCProtectFWRuleArrayFunc_V665;
	use MCProtectFWRuleMiscFunc_V665;
	use MCProtectFWRuleRequestFunc_V665;
	use MCProtectFWRuleWPFunc_V665;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V665::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V665 $e) {
			$this->error = $e;
		}
	}
