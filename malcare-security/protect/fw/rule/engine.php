...
if (!class_exists('MCProtectFWRuleEngine_V669')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V669 {
	use MCProtectFWRuleStringFunc_V669;
	use MCProtectFWRuleArrayFunc_V669;
	use MCProtectFWRuleMiscFunc_V669;
	use MCProtectFWRuleRequestFunc_V669;
	use MCProtectFWRuleWPFunc_V669;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V669::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V669 $e) {
			$this->error = $e;
		}
	}
