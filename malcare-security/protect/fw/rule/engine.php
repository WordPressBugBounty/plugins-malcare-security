...
if (!class_exists('MCProtectFWRuleEngine_V676')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V676 {
	use MCProtectFWRuleStringFunc_V676;
	use MCProtectFWRuleArrayFunc_V676;
	use MCProtectFWRuleMiscFunc_V676;
	use MCProtectFWRuleRequestFunc_V676;
	use MCProtectFWRuleWPFunc_V676;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V676::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V676 $e) {
			$this->error = $e;
		}
	}
